...
item_soccerball = Item('Soccer Ball', 'An inflated ball used in playing a game of soccer.')
item_snowboard = Item('Snowboard', 'A board resembling a short, broad ski, used for sliding downhill on snow')
item_bindings = Item('Bindings', 'Special boots which help secure both feet of a snowboarder, who generally rides in an upright position.')
